...
At some point, workers might read same messages again and again. Inoder to overcome that, In order to overcome that,I kept a DynamoDB in between SQS and worker. 
